...
|---|---|---|
| Benutzerkonto und Projektübersicht | Anmeldung, Startseite und Projektverwaltung zeigen den Einstieg in BitFlow und die grundlegende Nutzerführung außerhalb des Editors. | [TODO: Screenshot Anmeldung / Projektübersicht einfügen](https://github.com/BitFlow-DHBW/BitFlow/blob/main/docs/demo/Screenshots/anmeldung.png) |
